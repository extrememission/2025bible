document.addEventListener('DOMContentLoaded', () => {
    ...
    function toggleVerses(bookId, chapter, targetVerseNumber = null) {
        ...
        verses.forEach(verse => {
            ...
            const verseText = `${verse.field[4]}${bookNames[bookId]} ${chapter}:${verseNumber}`;
            ...
            if (targetVerseNumber && parseInt(verseNumber) === parseInt(targetVerseNumber)) {
                setTimeout(() => {
                    ...
                    const verseBoxContent = verseBox.innerHTML.split('')[1];
                    verseBox.innerHTML = `${highlightSpan.outerHTML}${verseBoxContent}`;
                }, 100);
            }
        });
    }
    ...
    function searchHandler() {
        ...
        setTimeout(() => {
            ...
            results.forEach(result => {
                ...
                const fullText = `${verseText}${bookName} ${chapter}:${verseNumber}`;
